...
-   [Zotero PDF Translate](https://github.com/windingwind/zotero-pdf-translate) : traduit les titres et les résumés des références Zotero pour les placer dans deux nouveaux champs. Traduction par défaut par Google (recommandé). On ne peut pas dépasser 10 références à la fois sans clé d'accès.
