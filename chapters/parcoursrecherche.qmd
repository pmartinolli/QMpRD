...
-   Opérateurs : ``` AND ``*`` OR () NOT ```
    ...
    -   Mars 2022 : toujours pas de possibilité de créer des alertes.
...
-   Web of Science est l'une des plus ancienne base de données bibliographiques et c'est aussi une plateforme qui diffuse d'autres bases de données.
...
-   Ouvrir WoS <https://www.webofscience.com/>. Onglet Documents.
   -   Search in :*Web of Science Core Collection*. Editions :*All*(ou une sélection d'index plus spécifiques à votre sujet, par exemple vous voudriez peut être exclure les index de science (SCI-Expanded) ou les index de conférences (CPCI). ☐
        -   Option pour les sciences humaines et sociales : Search In :*Current contents Connect*. ☐
-   Réglage du champ de recherche : remplacer*All Fields*par*Topic*. Cela ne va chercher que sur le titre, le résumé et les mots-clés libres (non contrôlés, il n'y a pas de thésaurus dans WoS). ☐
...
-   Combiner ses recherches :
    ...
    -   Cliquez sur le chiffre du nombre de résultat de la requête combinée. Et voilà ! Nous avons utilisé une fonction d'historique de recherche ☐ Cette méthode permet d'avoir plus de contrôle sur la recherche. En effet, plutôt que de lancer une recherche avec tous les thèmes en même temps, nous pouvons savoir à l'avance quel thème est trop gros, trop petit, pertinent ou pas. Hélas, cette fonction n'existe pas dans la majorité des bases de données.
...
-   Menu de gauche :
    ...
    -   Analyser les résultats :
        ...
        -   Comment ? Cliquez sur*Analyse Results*. ☐
            -   Cliquez sur*Web of Science Categories*et remplacez par :
            -   *Authors*ou*Editors*☐
            -   *Affiliations*☐
            -   *Publication Titles*☐
            -   Autres ☐
...
-   Mise en pratique \[15min.\] : repérez et sélectionnez un article pertinent dans Web of Science ☐
    -   Cliquez sur*Cited References*(donc la bibliographie de cet article) dans le menu*Citation Network*☐
    -   Cliquez sur*View as set of results*puis*Sort by : Citations highest first*☐
    -   Dans cette liste, repérez un document pertinent, hautement cité, cliquez dessus pour le sélectionner ☐
...
-   Avantages :
    ...
    -   Possibilité de faire des alertes sur les auteurs (idéalement) ou sur des mots-clés.
        -   Auteur : si le nom de l'auteur est souligné, ça veut dire qu'il maintient son profil lui-même et que vous serez prévenu dès qu'il réclame de nouvelles références dans Google Scholar voir chapitre [\[chap:MonID\]](#chap:MonID){reference-type="ref+page" reference="chap:MonID"}. Avoir un compte Google. Puis cliquez sur Follow.
...
-   Inconvénients <https://www.slideshare.net/Carl_Bergstrom/bergstrom-microsoft-bigscholarlydata> :
    ...
    -   Google Scholar a contribué à la popularité du *h-index*, un indicateur bibliométrique médiocre voire trompeur voir p..
...
-   2018\. Documents en libre accès, prépublications, données de recherche, etc <https://coop-ist.cirad.fr/trouver-l-information/utiliser-des-moteurs-de-recherche/4-dimensions-2018-moteur-se-presentant-comme-une-base-de-donnees>.

### Semantic Scholar <https://www.semanticscholar.org/>

-   2015\. Documents en libre accès, prépublications, etc. <https://coop-ist.cirad.fr/trouver-l-information/utiliser-des-moteurs-de-recherche/5-semantic-scholar-2015-moteur-base-sur-l-intelligence-artificielle>.

### Lens <http://lens.org/>

-   1998\. Données liées. Documents en libre accès, prépublications, données de recherche, etc. <https://coop-ist.cirad.fr/trouver-l-information/utiliser-des-moteurs-de-recherche/6-lens-1998-moteur-de-recherche-sophistique-et-expert>.

### Scinapse

-   2019\. Données liées. <https://coop-ist.cirad.fr/trouver-l-information/utiliser-des-moteurs-de-recherche/7-scinapse-meta-moteur-academique>.
...
-   Pourquoi ? C'est l'outil qui contient le plus de mémoires et thèses au monde. Couverture : Canada et États-Unis depuis le XIXe siècle. Depuis les années 90, souvent le PDF de la thèse est disponible. Notices bibliographiques de thèses d'ailleurs dans le monde (Europe, etc.).

-   Comment ?

    -   Allez sur <https://bib.umontreal.ca/> \> Chercher de l'information \> Bases de données de A à Z \> D \> Dissertations & Theses Global (ProQuest)

    -   Recherche avancée :

        -   Chaque ligne : indiquez les mots-clés d'un même thème (chaque synonymes séparés par des OR) ☐

        -   Entre les lignes : AND

        -   **Important**: remplacez Partout par Partout, sauf texte intégral - NOFT ☐

        -   Opérateurs : AND OR NOT guillemets troncature\*

    -   Lancez la recherche :

        -   Modifiez la recherche si besoin. ☐

        -   Utilisez les filtres sur le côté gauche : Date de publication, Langue, Sujet et Thème Indexé sont les plus recommandés. ☐

    -   Téléchargez une thèse à la fois en cliquant sur son titre pour afficher sa description complète.

        -   Avec le connecteur Zotero : Cliquez sur le chapeau de diplômé noir. Si le texte intégral est disponible, il devrait être téléchargé en même temps que la notice. ☐

        -   OU en cliquant sur Texte intégral sous la référence, si l'option est disponible. ☐

        -   OU en cliquant sur le bouton Obtenir et en suivant les instructions pour le repérer et/ou le faire venir à vous par Prêt entre bibliothèque. ☐

    -   Pour aller plus loin avec cet outil : utilisez les options Cité par et Références, si elles sont disponibles. ☐

### Autres bases de données de thèses en français
...
-   Plusieurs outils qui fonctionnent plus ou moins bien car maintenus par des institutions différentes :
    ...
    -   Theses.fr <http://www.theses.fr/>: thèses françaises, soutenues et en préparation. ☐

        -   Recherche avancée : mots-clés.

        -   Pas de OR dans une même case. Guillemets ne fonctionnent pas.

    -   Isidore <https://isidore.science/as>: thèses françaises. ☐
...
### Autres bases de données de thèses en anglais
...
## Moteur de recherche du web : Google
...
-   Astuce utilisant Google pour checher sur un site spécifique :
    ...
    -   **`site:www.url.com`**``` [``mes mots-clés``]`` ```
...
-   Comment ?
    ...
    -   Utiliser WayBackMachine <https://archive.org/web/>: soumettez une URL d'une page qui a disparu. Si Internet Archives en a une ou plusieurs copies, vous la verrez sur une chronologie cliquable. ☐
...
-   Exercices pratiques 1 : explorer ces ressources en ligne

    -   \[15min.\]***CitationTree*** <https://www.citationtree.org/>
    ...
    -   ***ResearchRabbit*** <https://www.researchrabbit.ai/>\[1h\]
        ...
        -   Synchronisable avec Zotero \[1h+\].

    -   ***Litmaps*** <https://www.litmaps.com/>\[1h\]

        -   À partir d'un article ou d'un ensemble d'articles, créer une carte (seed map) constituée d'une liste de références.

        -   Visualiser le poids et les liens de citations de chacun.

        -   Possibilité d'exporter la liste des références vers un logiciel bibliographique (format bibTeX).

        -   Nécessite de se créer un compte.

    -   ***Inciteful***.xyz <https://inciteful.xyz/>\[1h\]

        -   À partir d'un article ou d'un ensemble d'articles, permet de repérer des références qui citent les mêmes sources (Similar Papers) et de repérer des références très citées ou incontournables (Most Important Papers in the Graph).

        -   Il existe une extension Zotero avec les fonctions de base Voir p. ..

-   Exercices pratiques 2 (avancés) : installer ces logiciels de visualisation

    -   Un outil de visualisation permet d'avoir une vue d'ensemble sur un corpus déjà constitué. Ils peuvent être utiles lorsqu'on veut débroussailler un sujet et faire ressortir des réseaux de termes, de revues ou d'auteurs importants.

    -   Ces outils sont difficiles à manipuler et des compétences en bibliométrie sont parfois nécessaires pour comprendre les éléments à paramétrer. Typiquement, vous avez déjà un ensemble de plusieurs centaines de références, vous les exportez dans un logiciel comme VOSviewer et vous paramétrer les visualisations pertinentes.

    -   *VOS Viewer* <https://www.vosviewer.com/>\[1h\].

## Eureka.cc : texte intégral d'articles de journaux et de magazine
...
-   Pourquoi faire des recherches dans ces ensembles puisque, si les bases de données bibliographiques ont bien fait leur travail, je ne devrais y trouver que des choses que je connais déjà ?
    ...
    -   Ça prend 15 minutes \[15min.\] pour faire une recherche simple avec quelques mots-clés (pas trop) pour tester le contenu de chaque ensemble.

        -   Ces ensembles proposent rarement de faire des alertes. Si l'option existe, créez des alertes.

## BAnQ

-   Outils de recherche de la BAnQ <https://www.banq.qc.ca/rechercher/>

    -   Catalogue régulier des documents en prêt (livres, CD,...) https://cap.banq.qc.ca/

    -   BAnQ Numérique : collection numérisée du patrimoniale documentaire du Québec [https://numerique.banq.qc.ca/ allez dans la section Patrimoine québécois](https://numerique.banq.qc.ca/%20allez%20dans%20la%20section%20Patrimoine%20qu%C3%A9b%C3%A9cois). Collection parcourue : ☐
