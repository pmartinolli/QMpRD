...
-   2013 : Conception d'un portfolio documentaire (versions 1 et 2) dans le cadre du séminaire PLU6058 pour documenter les démarches de recherche d'information par rapport à un sujet de thèse ou mémoire <https://bib.umontreal.ca/multidisciplinaire/plu6058>.
...
-   2017 : Transposition partielle de la fonction « parcours de formation » sous la forme d'une feuille de personnage du chercheur <https://github.com/pmartinolli/TM_SchoCharSheet>.
-   2020 : Transposition partielle et simplifiée (pour étudiant.es de 1er cycle) de la fonction « parcours de formation » sous la forme d'un MOOC en 8 modules pour mettre à jour ses compétences informationnelles de base <https://catalogue.edulib.org/fr/cours/BIB-BONICI/>.
-   2021 : Transposition partielle de la fonction « parcours de formation » sous la forme d'un poster et d'un index en ligne <https://bib.umontreal.ca/parcours>.
