...
-   Un format de document, imprimé ou électronique, est un ensemble de **règles** pour la **production** et l'**utilisation** d'un document Marcello Vitali-Rosati et Michaël Eberle-Sinatra, [*Pratiques de l'édition numérique*](https://www.pum.umontreal.ca/catalogue/pratiques-de-ledition-numerique), Montréal, Presses de l'Université de Montréal, mars 2014.
...
+====================+=======================================+============================================+
| Texte              | ODT (OpenDocument Text)               | DOC (Microsoft Word)                       |
|                    |                                       |                                            |
|                    | RTF (Rich Text Format)                | PAGES (Apple)                              |
|                    |                                       |                                            |
|                    | TXT (Text)                            | WP (WordPerfect)                           |
+--------------------+---------------------------------------+--------------------------------------------+
...
+--------------------+---------------------------------------+--------------------------------------------+
| Tableau            | CSV (Comma-separated values)          | XLS (Microsoft Excel)                      |
|                    |                                       |                                            |
|                    | ODS (OpenDocument SpreadSheet)        | NUMBERS (Apple)                            |
+--------------------+---------------------------------------+--------------------------------------------+
...
+--------------------+---------------------------------------+--------------------------------------------+
| Audio              | FLAC (Free Lossless Audio Codec)      | AAC (Advanced Audio Coding)                |
|                    |                                       |                                            |
|                    | MP3 (MPEG-1/2_Audio_Layer_III)        | RAM (Real Audio Metadata)                  |
|                    |                                       |                                            |
|                    | OGG                                   | WMA (Windows Media Audio)                  |
|                    |                                       |                                            |
|                    | WAV (Waveform Audio File Format)      |                                            |
+--------------------+---------------------------------------+--------------------------------------------+
| Diaporama          | ODP (OpenDocument Presentation)       | KEY (Keynote Mac)                          |
|                    |                                       |                                            |
|                    |                                       | PPT (Microsoft PowerPoint)                 |
+--------------------+---------------------------------------+--------------------------------------------+
| Archive compressée | 7z (Seven Zip)                        | ACE                                        |
|                    |                                       |                                            |
|                    | TAR (Tape ARchiver)                   | RAR (Roshal ARchive)                       |
|                    |                                       |                                            |
|                    | ZIP                                   |                                            |
+--------------------+---------------------------------------+--------------------------------------------+
| Dessin             | EPS (Encapsulated PostScript)         | AI (Adobe Illustrator Artwork)             |
|                    |                                       |                                            |
|                    | ODG (OpenDocument Graphics)           | CDR (CorelDRAW)                            |
|                    |                                       |                                            |
|                    | SVG (Scalable Vector Graphics)        | FH (Adobe FreeHand)                        |
+--------------------+---------------------------------------+--------------------------------------------+

: Exemples de formats ([Source](https://doranum.fr/stockage-archivage/quiz-format-ouvert-ou-ferme_10_13143_mcwq-qs64/) : *Format ouvert ou fermé?* DoraNum, CC BY-NC-SA)
...
-   Bonnes pratiques :
    ...
    -   Faire des [sauvegardes](#sec-sauvegardedurable) règulières, datées de tous vos fichiers.
...
-   Il existe un **modèle de document** pour [mémoire et thèse UdeM](https://bib.umontreal.ca/gerer-diffuser/communication-savante/rediger-these-memoire), paramétré pour MS Word selon les règles des Études supérieures et postdoctorales de l'UdeM.
...
## Multiremplacements et expressions régulières
...
-   Outils de renommage de fichiers : [Bulk Rename](https://www.bulkrenameutility.co.uk/), [Utility Renamer](https://renamer.com/) for Mac, [PSRenamer](https://github.com/hbowie/psrenamer).
