...
-   Préalable : avoir installé Zotero selon les paramètres indiqué (voir @sec-zoteroinstaller).
-   Principes généraux :
...
-   Comment ?
    -   Option 1 : Créez la notice du livre. Clic-droit sur la notice \> Dupliquer le document. Changer le type du nouveau document pour : Chapitre de livre (ou article d'encyclopédie).
    -   Option 2 (avec l'extension Zutilo, activez l'option Créer une notice Chapitre de livre : menu contextuel de Zutilo) : Créez la notice du livre. Clic-droit sur la notice \> Zutilo \> Créer une notice Chapitre de livre. Un chapitre est créé et il est lié au livre avec l'option Connexe.
-   Voir @sec-zoteroplus pour d'autres astuces d'importation.
...
-   Nous verrons plus loin (@sec-zoteroorganiser) comment organiser sa bibliothèque Zotero de manière avancée .
