...
Cette section est une contribution partagée entre Cynthia Gagné (contributrice principale) et Pascal Martinolli.
...
-   La bibliométrie (*bibliometrics*) c'est un ensemble de **méthodes quantitatives**, selon des **indicateurs de publication**, pour **évaluer la recherche**.
    ...
    -   Une notion parallèle s'est développée : les ***altmetrics*** (*alternative metrics*) qui sont aussi des méthodes quantitatives mais qui sont basées surtout sur la visibilité médiatique des publications de la recherche.
...
-   Il y a eu un **détournement** de son intention originelle.
    ...
    -   En [Italie](https://blogs.lse.ac.uk/impactofsocialsciences/2022/07/04/bibliometrics-at-large-the-role-of-metrics-beyond-academia/), le Facteur d'impact a servi d'« outils de justice » pour pousser plus de valeurs méritocratiques au lieu de pratiques clientélistes au sein du monde de la recherche. Les indicateurs bibliométriques sont parfois utilisés dans la presse grand public comme un « sceau de qualité ».
...
-   Les indicateurs de publication sont des **critères d'autorité externes** à un document. A priori, ils ne disent rien [de la qualité](https://doi.org/10.1177/01455613221119051) du [contenu du document](https://doi.org/10.1371/journal.pbio.3002238).
...
-   Pour le meilleur ou pour le pire, les résultats des méthodes bibliométriques servent à **prendre des décisions critiques** pour la recherche :
    ...
    -   Pour faire des raccourcis de jugement ([heuristiques](https://researchprofessionalnews.com/rr-news-europe-views-of-europe-2023-2-metrics-have-their-merits/)) qui sauvent du temps aux évaluateurs.
    -   Pour donner un [semblant](https://researchprofessionalnews.com/rr-news-europe-views-of-europe-2023-2-metrics-have-their-merits/) d'objectivité lors de prises de décisions hors expertise.
...
-   **Autres biais** :
    ...
    -   Les femmes sont sous-représentées ([sous-valorisées](https://doi.org/10.1073/pnas.1915378117), [moins](https://doi.org/10.1073/pnas.1914221117) de publications, moins première autrice, moins de collaboration, moins [citées](https://doi.org/10.1038/s41586-022-04966-w), etc.).
    ...
    -   Des sources peuvent être citées [négativement](https://elifesciences.org/articles/72737) (« on est en désaccord » ou « on contredit ») : Très rare (moins de 1%).
...
-   Avec l'option *Cited References Search* : calculer combien de citations pour un article ou un auteur. Demandez de l'aide à votre bibliothécaire.

#### *Analyze Results* sur un sujet

-   Avec la recherche d'articles de base + l'option ***Analyze Results***.
    -   Lancez une recherche simple (avec peu de mots-clés pour avoir un nombre significatif de résultats)
    -   Dans la page de résultats, cliquez sur *Analyze Results.*
        -   Analyser les résultats par auteurs (*Authors*) : quels chercheurs ont le plus publiés sur ce sujet ?
        -   Par institutions (*Affiliations*) : où aller chercher des collaborations, aller faire son post-doc, etc. ?
        -   Par revues (*Publication Titles*) : où soumettre ses recherches ?
        -   Par subventions de recherche (*Funding agencies*)

#### Facteur d'impact d'une revue

-   C'est le plus ancien indicateur et le plus connu.
-   *Impact Factor* et Facteur d'impact sont des marques déposées par [Clarivate](https://clarivate.com/webofsciencegroup/essays/impact-factor/) (Web of Science, JCR,...).
-   Il est calculé à partir des données de Web of Science.
-   Calcul standard :
    -   Facteur d'impact d'une revue X en 2020 = $\frac{Nombre\ de\ citations\ reçues\ par\ la\ revue X}{Nombre\ de\ publications\ de\ la\ revue\ X\ en\ 2018\ et\ 2019}$.
...
-   On le trouve dans un outil nommé le [JCR](https://jcr.clarivate.com/jcr/home) (*Journal Citation Reports*).
    -   Aller dans la section du bas*See full listings and refine your search*\>*Browse categories*
    -   Sélectionner votre domaine et un sous-domaine, puis cliquer sur le nombre dans la colonne \# of journals du SCIE (sciences), du SSCI (sciences sociales) ou du AHCI (arts et humanités).
    -   Trier par facteur d'impact (JIF). ☐

#### InCites

-   Basé sur Web of Science Core Collection.
-   Se créer un [compte](https://incites.clarivate.com/).
...
-   [Accès](https://www.scimagojr.com/) gratuit.
...
-   Consulter le SCImago
    -   Cliquer sur Journal ranking (en haut).
    -   Sélectionner votre domaine et un sous-domaine (dérouler les cases All-subject area et all-subject categories).
    -   Trier par SJR ou Cites per doc. ☐

### h-index

-   C'est un indicateur **à la mode** mais **très controversé**.
    -   Son créateur l'a [renié](https://arxiv.org/ftp/arxiv/papers/2001/2001.09496.pdf) avec horreur.
...
-   Il a connu un grand succès grâce à Google Scholar, puis grâce au logiciel [Publish or Perish](https://harzing.com/resources/publish-or-perish).
...
-   En 2021, Clarivate (Web of Science, JCR,...) a proposé un indicateur qui permettrait de comparer entre les disciplines (grâce à la normalisation) et qui serait pertinent pour les arts et humanités : le **Journal Citation Indicator** (**JCI**).
    -   Pour rester poli, on va dire que ça n'a pas convaincu grand monde en raison de très nombreux [problèmes](https://scholarlykitchen.sspnet.org/2021/05/24/journal-citation-indicator/) de méthodologie et de compréhension des disciplines.
...
-   Elles sont basées surtout sur la **visibilité médiatique** des publications de la recherche ou d'autres critères non-traditionnels.
    -   Permet de repérer la **conversation scientifique** après publication. [Exemples](https://bmjopen.bmj.com/content/3/8/e002998.altmetrics) :
        -   Qui a microblogué et commenté (sur BlueSky, Mastodon,...) ?
...
-   Voir le chapitre sur les [éditeurs prédateurs](#sec-predateurs).
