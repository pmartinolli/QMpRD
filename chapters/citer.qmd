...
-   **Citer** ou **référencer/sourcer**
    ...
    -   Citer veut aussi dire **référencer/sourcer** (*citation*, *reference*), c'est à dire indiquer la source d'une idée, d'un propos, d'une information factuelle, d'un extrait de mots exacts d'un auteur, etc. Quand nous allons parler de citer, c'est ce sens-là qui sera privilégié.
        ...
        -   « Je pense donc je suis. » [(Descartes, 1637)]{.underline}
...
-   Autres raisons (non éthiques) :
    ...
    -   Pour obéir à une revue scientifique peu scrupuleuse qui vous demande [d'ajouter](https://pubpeer.com/publications/1924F147DE045B97261004EB2387AE#1) quelques références pour booster ses indicateurs bibliométriques de citation.
...
-   Autre définition : [Plagier](https://www.plagiarismtoday.com/2023/02/16/the-definition-of-plagiarism/), c'est utiliser le travail d'autrui, **sans donner une attribution appropriée**.
...
-   Recommandations :
    ...
    -   Reconnaître qu'on est influencé constamment par les informations que nous absorbons ([Viviane](https://youtu.be/91G8UN7UTQ0) de Sci+ *À partir de quand c'est du plagiat ?*)
...
3.  Choisir comment on veut **incorporer cette idée** : en paraphrasant ou avec un extrait exact ?
    ...
    -   Avec avec une **paraphrase** ou un **résumé** :
        ...
        -   Attention :
            ...
            -   Reprendre les mots [exacts](https://integrity.mit.edu/handbook/academic-writing/avoiding-plagiarism-paraphrasing) d'une source, mais sans mettre de guillemets, est considéré comme du plagiat (même si vous mettez la référence à la source).
...
-   Si une source A est mentionnée dans un document B que vous avez entre les mains, et si vous voulez reprendre l'idée exprimée :
    ...
    -   Il faut **faire** **tout votre possible** pour aller repérer et lire le document A.
        ...
        -   Ne faites pas confiance au document B pour avoir retranscrit fidèlement ou exactement les idées de A. [^citer-1]
...
[^citer-1]: À ce sujet, je vous invite à lire l'article « L'histoire de la note de bas de page mortelle » qui parle du manque d'éthique de ne pas aller vérifier la source soi-même et des dizaines de milliers de morts qui peuvent en être la [conséquence](http://www.slate.fr/story/147105/medecine-100-mots-tuer-en-medecine).
...
[^citer-2]: Titre d'un chapitre de *Ça tourne mal ! L'histoire méconnue et tumultueuse du cinéma français* de Philippe Lombard, 2019. Édition La Tengo.
...
-   Bien citer permet de respecter l'aspect moral du droit d'auteur mais, dans le cas d'une diffusion de votre recherche, cela ne suffit pas car il y aussi un aspect **patrimonial** au droit d'auteur (ie. les droits liés à l'utilisation).
    ...
    -   Si votre travail est diffusé, soyez attentif à ce que toutes les parties dont le droit d'auteur ne vous appartient pas n'enfreignent pas les [droits d'auteur](#sec-droitdauteur) d'autres personnes ou institutions les détenant : portions de texte, graphiques, schémas, photographies, tableaux, données, etc.
