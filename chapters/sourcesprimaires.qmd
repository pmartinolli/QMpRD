...
- S'attendre à utiliser des moteurs de recherche **médiocres** 
  - Donc ne pas rédiger des équations de recherche complexes ou longues
  - N'utiliser que quelques mots-clés seulement
- Toutes les archives numérisées ne sont pas toujours augmentées avec une **reconnaissance de caractères** du texte intégral. 
