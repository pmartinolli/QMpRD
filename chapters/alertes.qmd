...
-   Plusieurs outils :
    ...
    -   Avec un billet de votre blogue de recherche (voir @sec-bloguersarecherche).

    -   Avec Mastodon/ BlueSky/ XTwitter : avec un compte ou un #hashtag dédié (voir @sec-microbloguer).
