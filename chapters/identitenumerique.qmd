...
-   Wikimédia :
    -   Identifiant Wikidata: Voir @sec-wikipourlarecherche pour indexer votre profil dans Wikidata et y aligner vos identifiants pérennes.
    -   Wikipédia : Il est très très mal vu de rédiger une page Wikipédia sur soi-même. Si vous voulez une page Wikipédia à votre nom, assurez-vous d'avoir une [notoriété](#0) suffisante et de faire rédiger la page par des personnes tierces qui auront déclarés leurs conflits ou liens d'intérêt.
...
-   Optionnel :
    ...
    -   Dans les plateformes qui offrent cette fonction, créez d'autres alertes pour recevoir des notifications sur les citations que vous recevez, (voir @sec-alertes). Exemple : l'option *Follow* dans Google Scholar.
