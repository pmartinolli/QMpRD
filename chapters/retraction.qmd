...
-   En consultant manuellement la base de données **[Retraction Watch](http://retractiondatabase.org/RetractionSearch.aspx?)**. Désormais, leurs données sont versées dans CrossRef. 
