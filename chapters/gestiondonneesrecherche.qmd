...
-   Les noms de fichiers sont rédigés sans accent, ni espace ni caractère problématique. Les fichiers qui sont modifiés contiennent la date de modification dans le nom du fichier. Les fichiers passés sont conservés dans un sous-dossier \_archive présent dans tous les sous-dossiers où il est nécessaire. Aucun fichier n'est supprimé du projet de recherche.
...
-   Un **carnet de recherche** sous la forme d'un journal de bord journalier est rédigé chaque jour de recherche. Il documente les décisions prises ; les hypothèses et les questions soulevées et les conditions pour y répondre; ainsi que les résultats obtenus.
...
-   Les identifiants de chercheurs collaborateurs utilisent ORCID.
...
-   Le stockage actif sur l'ordinateur, les comptes infonuagiques et les clés USB devrait durer 2 ans.
...
-   Le stockage principal se trouve sur le disque dur du chercheur principal.

-   Les stockages de sauvegarde se trouvent sur des serveurs distants qui ne sont que des dépôts passifs de données.
...
-   Lorsqu'il souhaite recevoir la révision ou la rétroaction ou la collaboration d'un autre chercheur, il dépose une copie des données dans un dossier partagé de OneDrive. Il intègre ensuite manuellement les modifications choisies dans son projet principal.
