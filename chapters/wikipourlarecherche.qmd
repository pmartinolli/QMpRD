...
-   Quelques **critères avancés** :
    ...
    -   Onglet Discussion \>
        ...
        -   Quel est le statut de la page selon la communauté Wikipédia ? Le meilleur statut est**Article de qualité**(*featured article*), puis Bon article (*good article*) et ainsi de suite jusqu'à Ébauche (*stub*).
...
-   Wikipédia est sous licence [CC-BY-SA 3.0](https://creativecommons.org/licenses/by-sa/3.0/deed.fr)
...
-   Peut servir pour vos données de recherche :
    ...
    -   En phase exploratoire, ou en phase d'éxécution ou en phase de diffusion Pascal Martinolli « [Wikidata : un outil pour vous, les chercheurs](https://www.acfas.ca/publications/magazine/2020/06/wikidata-outil-vous-chercheurs) » ACFAS Magazine, 4 juin 2020. .
...
### Indexer son profil de chercheur dans Wikidata 
...
-   Comment ? \[1h\]
    ...
    -   Éligibilité : En juin 2019, le consensus social sur la [notoriété](https://www.wikidata.org/wiki/Wikidata:Notability/fr) des [éléments](https://www.wikidata.org/wiki/Topic:V2bwkulb3m2kfnk6) de Wikidata dit qu'il est possible de créer un élément Wikidata au nom d'un.e chercheur.se si :
    ...
    -   [Tutoriel](https://www.wikidata.org/wiki/User:Pmartinolli/Curation_chercheurs_UdeM) et suggestions pour créer ou améliorer son identifiant Wikidata
    ...
    -   Utiliser [Author-disambiguator](https://author-disambiguator.toolforge.org/) pour réclamer vos publications.
