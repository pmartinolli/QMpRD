...
-   Avec un logiciel adapté comme [Obsidian.md](https://obsidian.md/) (logiciel non libre, mais gratuit pour une utilisation personnelle).
    ...
    -   Optionnel : [Obsidian Web Clipper](https://obsidian.md/clipper) pour capturer des morceaux de pages web.
...
-   Rédiger des notes dans Obsidian est l'opportunité idéale pour pratiquer le balisage léger Markdown.

-   Pour une utilisation un peu plus avancée : utiliser [Quarto ou Zettlr](#sec-markdown).
